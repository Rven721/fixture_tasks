...
def pytest_addoption(parser):
    parser.addoption('--browser_name', action='store', default = 'firefox', help='You can choose firefox or chrome')
...
def browser(request):
    ...
    if browser_name == 'chrome':
        ...
        """Если не запускается Хром - удалите 'executable_path' из инициализации барузера"""    
